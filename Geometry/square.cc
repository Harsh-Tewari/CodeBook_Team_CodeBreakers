...
3) Conic Rotations
Given elipse: Axˆ2 + Bxy + Cyˆ2 + Dx + Ey + F = 0
Convert it to: Axˆ2 + Bxy + Cyˆ2 + Dx + Ey = 1 (this formula suits better for elipse, before doing this
verify F = 0)
Final conversion: A(x + D/2A)ˆ2 + C(y + E/2C)ˆ2 = 1 + Dˆ2/4A + Eˆ2/4C
B != 0 (Rotate):
